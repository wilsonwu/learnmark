<%@ Page Title="Learnmark 零码 - 业务体系 - 零码软件" Language="C#" MasterPageFile="~/Masters/SubPage.master" AutoEventWireup="true" CodeBehind="Learnmark.aspx.cs" Inherits="Learnmark.Website.LearnmarkCorp.Business.Learnmark" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div style="float:left; width:214px;">
        ...
        <div style="height:24px; margin-left:26px; margin-top:28px; width:163px; background-color:#E7E7E7; line-height:24px;">
            <div style="color:#444444; float:left; font-size:14px; line-height:24px; font-family:微软雅黑; font-weight:bold; padding-left:6px;">业务体系</div>
        ...
        <div class="leftnav">
            <ul>
                <li style="padding-left:35px; height:26px; line-height:26px; background-image:url('../Images/sub/sub_left_bg.gif'); background-position:center center; background-repeat:no-repeat;"><a href="Learnmark.aspx">零码软件</a></li>
                <li style="padding-left:35px; height:26px; line-height:26px; background-repeat:no-repeat;"><a href="Education.aspx">零码教育</a></li>
                <li style="padding-left:35px; height:26px; line-height:26px; background-repeat:no-repeat;"><a href="ITService.aspx">零码科技</a></li>
                <li style="padding-left:35px; height:26px; line-height:26px; background-repeat:no-repeat;"><a href="Talent.aspx">软件人才</a></li>
            </ul>
        </div>
    </div>
    <div style="float:left; width:786px;">
        ...
        <div style="height:37px; margin:26px 26px 22px 0px;">
            ...
            <div style="float:left; width:700px;height:37px;background-image:url('../Images/sub/sub_right_top_bg_m.gif'); background-position:left center; background-repeat:repeat-x;;">
                <div style="padding-left:12px; margin-left:14px; height:37px; line-height:37px; background-image:url('../Images/left_bigdot.gif'); background-position:left center; background-repeat:no-repeat;">
                    <span style="font-family:微软雅黑; font-weight:bold; color:Red; font-size:14px; ">零码软件</span>
                    <span style="font-family:微软雅黑; color:#b2b1b1; font-size:12px; ">LEARNMARK SOFTWARE</span>
                </div>
            </div>
        ...
        <p>零码软件（Learnmark Software）为零码公司成员，专注于高端企业级软件研发管理培训，通过整合全球优质 IT教育资源，致力于为广大企业客户提供最优秀的软件研发管理培训。努力打造中国高端企业级软件研发管理培训的知名品牌。</p>
        <p>零码软件汇聚了对IT教育培训抱有远大理想的顶尖技术专家及各领域优秀人才。通过自己的不懈努力，零码软件已经成长为中国企业级软件研发管理培训的专家，赢得了包括微软、新电、天府软件园、IBM、SAP、西门子、Nokia、Symantec、联想、华为、腾讯等世界500强公司在内的众多著名企业客户的赞誉。</p>
        <p>零码软件网站：<a href="http://www.learnmark.com" target="blank">www.learnmark.com</a></p>
        </div>
    </div>
</asp:Content>
