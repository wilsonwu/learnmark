<%@ Page Title="Learnmark 零码 - 业务体系 - 软件人才" Language="C#" MasterPageFile="~/Masters/SubPage.master" AutoEventWireup="true" CodeBehind="Talent.aspx.cs" Inherits="Learnmark.Website.LearnmarkCorp.Business.Talent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div style="float:left; width:214px;">
        ...
        <div class="leftnav">
            <ul>
                <li style="padding-left:35px; height:26px; line-height:26px; background-repeat:no-repeat;"><a href="Learnmark.aspx">零码软件</a></li>
                ...
                <li style="padding-left:35px; height:26px; line-height:26px; background-image:url('../Images/sub/sub_left_bg.gif'); background-position:center center; background-repeat:no-repeat;"><a href="Talent.aspx">软件人才</a></li>
            </ul>
        </div>
    </div>
    <div style="float:left; width:786px;">
        ...
        <div style="height:37px; margin:26px 26px 22px 0px;">
            ...
            <div style="float:left; width:700px;height:37px;background-image:url('../Images/sub/sub_right_top_bg_m.gif'); background-position:left center; background-repeat:repeat-x;;">
                <div style="padding-left:12px; margin-left:14px; height:37px; line-height:37px; background-image:url('../Images/left_bigdot.gif'); background-position:left center; background-repeat:no-repeat;">
                    <span style="font-family:微软雅黑; font-weight:bold; color:Red; font-size:14px; ">软件人才</span>
                    <span style="font-family:微软雅黑; color:#b2b1b1; font-size:12px; ">TALENT</span>
                </div>
            </div>
        ...
        <p>提供软件外包及软件人才派遣服务，详情咨询：learnmark_talent@learnmark.com</p>
        </div>
    </div>
</asp:Content>
