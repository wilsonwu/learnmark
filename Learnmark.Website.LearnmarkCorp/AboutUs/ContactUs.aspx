<%@ Page Title="Learnmark 零码 - 公司信息 - 联系我们" Language="C#" MasterPageFile="~/Masters/SubPage.master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="Learnmark.Website.LearnmarkCorp.AboutUs.ContactUs" %>
    ...
    <div style="float:left; width:214px;">
        ...
        <div class="leftnav">
            <ul>
                ...
                <li style="padding-left:35px; height:26px; line-height:26px; background-repeat:no-repeat;"><a href="PressReleases.aspx">公司动态</a></li>
                ...
                <li style="padding-left:35px; height:26px; line-height:26px; background-image:url('../Images/sub/sub_left_bg.gif'); background-position:center center; background-repeat:no-repeat;"><a href="ContactUs.aspx">联系我们</a></li>
            </ul>
        </div>
    </div>
    <div style="float:left; width:786px;">
        ...
        <div style="height:37px; margin:26px 26px 22px 0px;">
            ...
            <div style="float:left; width:700px;height:37px;background-image:url('../Images/sub/sub_right_top_bg_m.gif'); background-position:left center; background-repeat:repeat-x;;">
                <div style="padding-left:12px; margin-left:14px; height:37px; line-height:37px; background-image:url('../Images/left_bigdot.gif'); background-position:left center; background-repeat:no-repeat;">
                    <span style="font-family:微软雅黑; font-weight:bold; color:Red; font-size:14px; ">联系我们</span>
                    <span style="font-family:微软雅黑; color:#b2b1b1; font-size:12px; ">CONTACT US</span>
                </div>
            </div>
        ...
        <div style="margin:0px 84px 17px 16px; font-size:12px; color:#807f7f; line-height:27px;">
            <ul style="list-style-type:none; padding:0; margin:0;">
                <li style="font-size:14px;"><strong>零码总部</strong></li>
                <li>地址：成都市高新区天府大道中段765号天府软件园A区3号楼二层</li>
                <li>邮编：610041</li>
                <li>电话：028 – 65800958</li>
                <li>传真：028 – 85332774</li>
                <li>电子邮箱：info@learnmark.com</li>
            </ul>
        </div>
    </div>
</asp:Content>
